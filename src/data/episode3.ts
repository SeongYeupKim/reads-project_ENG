...
export const episode3: EpisodeContent = {
  ...
  narrative: `Sumin was flipping through hospital records. At first she thought it was simple coincidence. People forget sometimes—names, appointments, where they put things.

But when the records started to add up, the picture changed. Sumin gathered patient records from the last two months and looked. People with similar symptoms. Recent memory fading. Forgetting what they just said. Trouble concentrating. Ages varied. Some patients were in their twenties, some over sixty.

Sumin paused on a page. It was the lifestyle section—where patients' usual diet and work were recorded. She read that part again. Most were connected to the sea. Fishermen. Seafood shop owners. Restaurant staff. She thought for a moment. In this village everyone eats fish. So that alone didn't explain it.

She looked at the records more closely. Type of fish. One patient had written that they ate small anchovies; another that they often ate large fish. Sumin turned the pages and began making a list. Tuna, sea bass, flounder, mackerel. She paused. These fish had something in common. They weren't small fish—they were species that eat other fish. They were clearly related in **trophic level**.
...
Sumin looked back at the records. It was still too little to call an explanation. But it was a bit too regular to call coincidence.`,
  anchoring: [
    {
      id: "ep3-q1",
      type: "situation",
      text: "What situation does Sumin face in this story?",
    ...
    },
    {
      id: "ep3-q2",
      type: "claim_evidence",
      text: "Why did Sumin say 'In this village everyone eats fish. So that alone didn't explain it'?",
    ...
    },
    {
      id: "ep3-q3",
      type: "claim_evidence",
      text: "What common feature did Sumin find for the fish on her list (tuna, sea bass, flounder, mackerel)? Why does it matter? Explain in one sentence.",
    ...
    },
    {
      ...
      text: "Sumin said 'It was still too little to call an explanation. But it was a bit too regular to call coincidence.' What does this imply?",
    ...
    },
    {
      ...
      text: "What additional data or methods would be needed to turn Sumin's observations (fish type, trophic level, domoic acid, hippocampus) into an 'explanation'?",
  ...
  selfExplanation: [
    ...
    },
    {
      id: "ep3-se1",
      goal: "cause_effect",
      text: "**What did Sumin observe** and **what hypothesis or possibility did she form**? Explain in your own words, linking cause and effect.",
      ...
      misconceptionPatterns: ["only list", "no Sumin's conclusion (still insufficient)"],
    ...
    },
    {
      ...
      text: "Explain why Sumin connected **domoic acid**, **hippocampus**, and **trophic level**, using the passage and your understanding. Link **evidence and reasoning**.",
  ...
  quiz: [
    {
      id: "ep3-quiz-1",
      question: "What did the fish on Sumin's list (tuna, sea bass, flounder, mackerel) have in common?",
    ...
    },
    {
      ...
      correctIndex: 1,
      feedback: "Sumin remembered learning that toxins like domoic acid can affect the human brain's hippocampus, which is involved in memory formation.",
    },
    {
      id: "ep3-quiz-3",
      question: "Why did Sumin say 'fish alone didn't explain it'?",
    ...
    {
      id: "ep3-quiz-4",
      question: "What is Sumin's conclusion at the end of the story?",
