...
export const episode1: EpisodeContent = {
  ...
  narrative: `Amy had returned to her hometown for summer research.
...
Walking along the pier, Amy found her father. He was mending nets.
...
Amy said nothing. People forget things sometimes.
...
Amy stopped when she heard that. Forgetful. That word was often heard on the pier.

She went home and took out her notebook. It was for research. She had brought it to record marine life. But Amy started writing something else.
...
Amy paused her pen. Was it just coincidence? Or was the same thing happening to many people?`,
  anchoring: [
    {
      id: "ep1-q1",
      type: "situation",
      text: "What problem does Amy face in this story?",
      keywords: ["repeated memory/lapses", "father and fishermen", "unclear if coincidence or pattern", "starts observation log"],
      misconceptionPatterns: ["only mention memory problems and miss 'repeated in many people'", "state conclusion without Amy's question (coincidence vs pattern)"],
      rubric: { "0": "none/error", "1": "partial (one or two events only)", "2": "sufficient (repeated memory issues + Amy's question and decision to record)" },
    },
    {
      id: "ep1-q2",
      type: "claim_evidence",
      text: "Give a 'fact (observation)' from the passage that could be a reason for Amy thinking 'Was it just coincidence?'",
      keywords: ["father repeating same question", "fishermen forgetting location, conversation", "several people", "similar time"],
      misconceptionPatterns: ["only Amy's feelings", "general claim without specific observed examples"],
      rubric: { "0": "none/error", "1": "partial (one fact only)", "2": "sufficient (two or more specific observations from passage)" },
    },
    {
      id: "ep1-q3",
      type: "claim_evidence",
      text: "Why might Amy have started writing 'something else' in her research notebook? Explain using evidence from the passage.",
    ...
    },
    {
      ...
      text: "After Amy thought 'People forget things sometimes,' she saw similar things the same day and the next. How might her thinking have changed?",
  ...
  selfExplanation: [
    ...
    },
    {
      id: "ep1-se1",
      goal: "cause_effect",
      text: "In this story **what happened** and, as a result, **what did Amy decide to do**? Explain in your own words, linking cause and effect.",
      keywords: ["father and fishermen repeated memory lapses", "Amy's question (coincidence vs pattern)", "village observation log in notebook", "cause (repeated observations) → result (recording, question)"],
      misconceptionPatterns: ["only list events", "end without Amy's action or decision"],
      rubric: { "0": "none/error", "1": "partial (only some, or weak cause-effect)", "2": "sufficient (what happened + Amy's action/decision linked causally)" },
    },
    {
      id: "ep1-se2",
      goal: "evidence_reason",
      text: "Find **evidence** in the passage for Amy thinking 'Was it just coincidence? Or was the same thing happening to many people?' and explain how it **connects to that question**.",
      keywords: ["father repeating question", "fishermen forgetful", "several people, similar time", "observed facts → question"],
      misconceptionPatterns: ["general claim without quoting passage", "only repeat Amy's thought without evidence"],
      rubric: { "0": "none/error", "1": "partial (one piece of evidence)", "2": "sufficient (evidence from passage linked to question)" },
    },
  ],
  miniLesson: `In science we first separate "what was seen or heard" and record it. That is observation (facts). Then "why might that be?" is interpretation or inference. The same phenomenon seen once might be coincidence; when it repeats across many times or many people, we consider the possibility of a pattern. Like Amy, when we record observations systematically, we can better judge later whether it's a pattern or coincidence.`,
  quiz: [
    {
      id: "ep1-quiz-1",
      question: "What did Amy start writing in her notebook?",
    ...
    {
      id: "ep1-quiz-2",
      question: "What happened right after Amy thought 'People forget things sometimes'?",
      options: ["Her father got better", "The next day at the pier she saw fishermen also showing similar forgetfulness", "Amy quit her research", "A storm hit the sea"],
      correctIndex: 1,
    ...
    {
      id: "ep1-quiz-3",
      question: "What question does Amy raise at the end of the story?",
